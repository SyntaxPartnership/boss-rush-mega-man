...
func load_config():
	...
	if err: #Assuming that options.cfg doesn't exist.
		...
		global.quick_swap	= config.get_value("options", "quick_swap", true)
		global.use_analog	= config.get_value("options", "use_analog", true)
		global.dash_btn		= config.get_value("options", "dash_btn", true)
		global.dbl_tap_dash	= config.get_value("options", "dbl_tap_dash", true)
		global.a_charge		= config.get_value("options", "a_charge", false)
		global.a_fire		= config.get_value("options", "a_fire", false)
		global.r_fire		= config.get_value("options", "r_fire", false)
		global.chrg_sfx		= config.get_value("options", "chrg_sfx", false)
